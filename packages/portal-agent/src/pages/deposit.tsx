...
export function DepositPage() {
    ...
    const mutation = useMutation({
        mutationFn: async () => {
            return api.post<PostingReceipt>('/tx/deposit', {
                agent_id: actor!.id,
                        ...
                        <CardContent className="flex flex-col gap-4">
                            ...
                            {mutation.isError && (
                                <p className="text-sm text-destructive">
                                    {mutation.error?.message ?? 'Deposit failed. Please try again.'}
                                </p>
                            )}
                        </CardContent>
                        <CardFooter>
                            ...
                            >
                                {mutation.isPending ? 'Processing…' : 'Submit Deposit'}
                            </Button>
                        </CardFooter>
                    </form>
                </Card>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-center">
                            The cash-in has been processed successfully.
                        </DialogDescription>
                    </DialogHeader>
                    {receipt && (
